            ...
            {items.map((item, idx) => (
              ...
              >
                <Link
                  href={item.href}
                  key={item.title}
                  className="h-10 w-10 rounded-lg flex items-center justify-center backdrop-filter-blur-lg saturate-180 bg-opacity-75 bg-black-200 border border-black-300"
                >
  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className="aspect-square rounded-lg flex items-center justify-center relative backdrop-filter-blur-lg saturate-180 bg-opacity-75 bg-black-200 border border-black-300"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
